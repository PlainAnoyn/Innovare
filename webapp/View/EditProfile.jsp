                    ...
                    <section class="sign-up">
                        <form action="${pageContext.request.contextPath}/updateProfile" method="POST"
                                    ...
                                    <%} %>
                                        <span class="password">
                                            ...
                                            <input type="text" id="password" name="password"
                                                placeholder="Enter Password" required value="${user.password}">
                                            <p>Password:</p>
                                        </span>
                                        <span class="confirm-password">
                                            <label for="confirm-password"></i></label>
                            ...
                            <div class="image-field" id="image-field">
                                <img src="${pageContext.request.contextPath}/userImage/11@11.png?v=${time}"
