    ...
    <body>
        ...
        <header>
            ...
            <div class="right">
                ...
                <div class="icons">
                    ...
                    <div class="order" onclick="orderClicked()">Order
                        ...
                        <%} else{ email=session.getAttribute("loggedInId").toString(); %>
                            <%if(session.getAttribute("adminEmail") !=null){%>
                                ...
                                <a href="${pageContext.request.contextPath}/admin-page" class="admin-btn">Admin
                                    Page</a><br />
                                <a href="${pageContext.request.contextPath}/index.jsp" class="admin-btn">Return to
                                    Home</a><br />
                    <a href="${pageContext.request.contextPath}/admin-page" class="admin-btn">Dashboard</a><br />
          			<a href="${pageContext.request.contextPath}/manageusers" class="admin-btn">Users Record</a><br />
          			<a href="${pageContext.request.contextPath}/View/AddProduct.jsp" class="admin-btn">Add Product</a><br />
          			<a href="${pageContext.request.contextPath}/manageproducts" class="admin-btn">Edit Product</a><br /> 
                                <%}%>

                                    <%if(session.getAttribute("adminEmail")==null && session.getAttribute("loggedInId")
                                        !=null){%>
        ...
        <div class="add-product-form">
            <form action="../addproduct" method="post" enctype="multipart/form-data">
                ...
                <div class="bottom">
                    <button style="font-weight:bold;" type="submit" value="Add Product">Add Product</button>
