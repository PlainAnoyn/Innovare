...
@media screen and (max-width: 600px) {
  ...
  .product-table td {
    ...
    <i class='bx bx-user'></i> <!-- Change bx-user to the class of your desired icon -->
</div>
								...
								<%} else{ email=session.getAttribute("loggedInId").toString(); %>
									<%if(session.getAttribute("adminEmail") !=null){%>
										<a href="${pageContext.request.contextPath}/admin-page" class="admin-btn">Admin
											Page</a><br />
										<a href="${pageContext.request.contextPath}/index.jsp" class="admin-btn">Go back Home</a><br />
